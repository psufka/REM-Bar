...
**How to install:** Download `REM-Bar-v0.1.1.zip` [here](https://github.com/psufka/REM-Bar/releases/download/v0.1.1/REM-Bar-v0.1.1.zip), unzip it, and move `REM-Bar.app` to `/Applications`.
